...
//--- 策略选择 ---
input group "策略选择"
input string StrategyVariant = "trend_pullback"; // 策略变体 (base/rsi/time/rsi_time/enhanced/trend_pullback/combo/DonchianBreakout)
...
input double BollMR_ProtectATRMultiplier = 0.8;   // 中轨保护带ATR倍数，建议0.6~1.0
input double BollMR_TrailingATR          = 1.5;   // 突破上轨后追踪止损 ATR 倍数
input double BollMR_TrailingStep         = 0.5;   // 追踪止损每次上移最小步长
